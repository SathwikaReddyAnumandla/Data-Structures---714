public class ArrayOperations {
    ...
    throw new ArrayIndexOutOfBoundsException("Array is full so it cannot elements");
    }
    array[size++] = element;
    }
    ...
    if (size >= array.length) {
    throw new ArrayIndexOutOfBoundsException ("Array if full so it cannot take elements");
    }
